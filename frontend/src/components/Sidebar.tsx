		...
		<div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
			<div className="bg-[#121212] h-[15%] rounded flex flex-col justify-around">
				<div className="flex items-center gap-3 pl-8 cursor-pointer" onClick={() => navigate('/')}>
					<img src="/home.png" alt="" className="w-6 text-white" />
					<p className="font-bold">Home</p>
				</div>
				<div className="flex items-center gap-3 pl-8 cursor-pointer">
					<img src="/search.png" alt="" className="w-6 text-white" />
			...
			<div className="bg-[#121212] h-[85%] rounded">
				...
				{user?.role === 'admin' && <button className="px-4 py-1.5 bg-white text-black text-[15px] rounded-full mt-4 cursor-pointer" onClick={() => navigate('/admin/dashboard')}>Admin Dashboard</button>}
			</div>
		</div>
	)
}
